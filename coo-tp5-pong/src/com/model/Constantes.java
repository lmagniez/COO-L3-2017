...
public abstract class Constantes {
	...
	public static final int BALLE_X_J1=DIMENSION_X*1/10;
	public static final int BALLE_X_J2=DIMENSION_X*9/10;
	
	//raquette
	public static final int RAQUETTE_X_J1=DIMENSION_X*1/12;
	public static final int RAQUETTE_X_J2=DIMENSION_X*11/12;
	public static final int RAQUETTE_Y=DIMENSION_Y/2;
	public static final int RAQUETTE_VITESSE=3;
	public static final int RAQUETTE_HEIGHT=50;
	public static final int RAQUETTE_WIDTH=10;
