 ...
 *
 */
public class ChoixCarte extends JPanel{
	...
	public ChoixCarte(EcranJeu e){
		...
		confirmer=new ButtonMenu("Piocher",Colors.textColor2,Colors.case8);
	 ...
	 */
	public void genererPiocheCarte(int idJoueur, int idCarte, String msg, TypePioche type){
	...
	{ 
		public void actionPerformed(ActionEvent e) {
			...
			InfoJoueur info=ChoixCarte.this.ecran.getS().getJoueurs()[ChoixCarte.this.ecran.getTour()];
			int idJoueur=ChoixCarte.this.ecran.getTour();
			int posJoueur=ChoixCarte.this.ecran.getP().getPions()[idJoueur].position;
			
			if(command=="Piocher")
			{
				ChoixCarte.this.ecran.getVue().getControler().requestEffetPioche(idJ1,idCarte, type);
				ChoixCarte.this.setVisible(false);
				ChoixCarte.this.actif=false;
